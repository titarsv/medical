         ...
         champ: function(options) {
            ...
            return this.each(function() {
                ...
                tab_content_selector.each(function(){  
                    ...
                    $(this).attr("data-title", add_relation);
                    div_rel++;
                });
                ...
                $(".accordian_header").click(function(){
                    var clicked_header = $(this).attr("data-title");
                    ...
                    if (content_status == "none") {
                        ...
                        get_closest_parent.find(" > div > div.tab_content."+clicked_header).addClass("active").slideUp();
                    }
                });
