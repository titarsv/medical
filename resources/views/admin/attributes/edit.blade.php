            ...
            <div class="panel-group">
                <div class="panel panel-default">
                    ...
                    <div class="panel-body">
                        ...
                        <div class="form-group">
                            <div class="row">
                                <label class="col-sm-2 text-right">Параметры</label>
                                <div class="form-element col-sm-10">
                                    <div class="row form-group">
                                        <div class="col-xs-6 attribute-name">
                                            <input name="unit" class="form-control" value="{{ old('unit') ? old('unit') : $attribute->unit }}" type="text" placeholder="Единица измерения">
                                        </div>
                                        <div class="col-xs-6 attribute-name">
                                            <select name="filter_type" class="form-control">
                                                @foreach($filter_type as $type => $name)
                                                    <option value="{!! $type !!}"
                                                            @if ($type == old('filter_type'))
                                                            selected
                                                            @elseif ($type == $attribute->filter_type)
                                                            selected
                                                            @endif
                                                    >{!! $name !!}</option>
                                                @endforeach
